...
export function VortexPlanet(props: { up?: Vector3; scale?: Vector3; rotation?: Euler; children?: ReactNode; href:string; spinSpeed:number; 
  colorBase: Color; colorBeach: Color; colorMid: Color; colorPeak: Color; 
  ...
  const uniforms = useMemo(
    () => ({
      ...
      u_colorBase: { value: new Color("#000000") },
      u_colorBeach: { value: new Color("#000000") },
      u_colorMid: { value: new Color("#000000") },
      u_colorPeak: { value: new Color("#000000") },
    }),
    []
  );
  const [hovered, setHovered] = useState(false) //introduce hover state

  uniforms.u_colorBase.value = props.colorBase
  uniforms.u_colorBeach.value = props.colorBeach
  uniforms.u_colorMid.value = props.colorMid
  uniforms.u_colorPeak.value = props.colorPeak
